...
#'
#' @description This function run the state-space equations for expansion infinite of moving average in processes LS-ARMA or LS-ARFIMA.
#'
#' @details
...
#'
#' @param m (type: numeric) truncation order of the MA infinity process. By default \eqn{m = 0.25*n^{0.8}} where \code{n} the length of \code{series}.
#'
#' @references
