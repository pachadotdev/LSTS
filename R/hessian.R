...
#'
#' @details
#' Computes numerical approximation to Hessian of \code{f}, evaluated at \code{x0}.
#' Usually needs to pass additional parameters (e.g. data).  N.B. this uses no numerical
#' sophistication.
#'
#' @param f (type: numeric) name of function that defines log likelihood (or negative of it).
#'
#' @param x0 (type: numeric) scalar or vector of parameters that give the point at which you
#' want the hessian estimated (usually will be the mle).
#'
