...
#'
#' @description This function calculates log-likelihood with known \eqn{\theta}, through \code{LS.whittle.loglik} function.
#'
#' @details
...
#'
#' @param theta.par (type: numeric) vector with the known parameters of the model.
#'
#' @examples
