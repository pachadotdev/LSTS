...
#' model.
#' @export
ls_whittle_loglik_sd <- function(x, series, order = c(p = 0, q = 0), ar_order = NULL, ma_order = NULL, sd_order = NULL, d_order = NULL, include_d = FALSE, w = NULL, s = NULL, include_taper = TRUE, theta_par = numeric()) {
  x <- c(theta_par, x)
